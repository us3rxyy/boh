...
🔗 https://esplodi-1-nafisofia110.replit.app
...
🔗 Riconnetti Spotify: https://esplodi-1-nafisofia110.replit.app`;
    await sock.sendMessage(chatId, { text: replyMessage });
    return;
  }
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('URL del bot: https://esplodi-1-nafisofia110.replit.app');
});